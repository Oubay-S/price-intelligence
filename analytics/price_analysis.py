...
DEFAULT_ANALYTICS_ROOT = Path(__file__).resolve().parent
DEFAULT_PROJECT_ROOT = DEFAULT_ANALYTICS_ROOT.parent
DEFAULT_BQ_TABLE = "price-intelligence-495411.price_intelligence.products"
DEFAULT_RAW_DATA_DIR = DEFAULT_ANALYTICS_ROOT / "outputs" / "raw_data"
