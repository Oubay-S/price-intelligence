  ...
  create or replace view `price-intelligence-495411`.`price_intelligence`.`stg_prices`
  OPTIONS()
  as -- models/staging/stg_prices.sql
...
WITH source_data AS (
    SELECT * FROM `price-intelligence-495411`.`price_intelligence`.`products`
)
